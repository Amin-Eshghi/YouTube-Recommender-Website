...
# =============================================================================
#     
#         return render_template('index - 1.html',tables=[df_estimate.to_html(classes='male')],
...
# ====================================One hot encoder fot future caption===================================  
    ...
    y2 = df['likes'].values
    regressor2 = RandomForestRegressor(n_estimators = 80, random_state = 0)
    ...
    regressor3 = RandomForestRegressor(n_estimators = 80, random_state = 0)
