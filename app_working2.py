...
# ====================================One hot encoder fot future caption===================================  
    ...
    y1 = df['views'].values
    regressor1 = RandomForestRegressor(n_estimators = 800, random_state = 0)
    ...
    y2 = df['likes'].values
    regressor2 = RandomForestRegressor(n_estimators = 800, random_state = 0)
    ...
    regressor3 = RandomForestRegressor(n_estimators = 800, random_state = 0)
...
# ====================================test case for first 10================================================
    ...
    test_views =str(int(sum(test_views)/len(test_views)))+'%'
    test_likes =str(int(sum(test_likes)/len(test_likes)))+'%'
    test_dislikes =str(int(sum(test_dislikes)/len(test_dislikes)))+'%'
...
#            'Views': [test_views1], 'Likes': [test_likes1], 'Dislikes': [test_dislikes1]})
# =============================================================================
